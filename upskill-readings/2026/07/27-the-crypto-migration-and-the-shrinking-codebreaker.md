...
- **Why that distinction pays:** it means quantum chemistry is not entering an empty field. Electronic structure is one of the largest consumers of HPC (high-performance computing) cycles on the planet, and that incumbent is *also* improving — which is exactly why the crossover in **C** sits where it does.
